    ...
    @section('content')
        <!-- BEGIN PAGE CONTENT-->
                 ...
                 <div class="profile-content">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal two-column-layout-form" name="frm_user_edit" id="frm_user_edit" action="" method="post" novalidate="novalidate">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title tabbable-line">
                                        ...
                                        <div class="actions">
                                            <a href="javascript:void(0);" id="anc_edit_user" class="btn btn-default btn-circle display_value_section">
                                                <i class="fa fa-pencil"></i>
                                                <span class="hidden-480">Edit</span>
                                            </a>
                                            <a class="btn blue-madison btn-circle btn-sm" href="{{url('admin/users')}}"> <i class="fa fa-arrow-left"></i> Back</a>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-lg-6 form-group">
                                            ...
                                            <span class="clearfix"></span>
                                            <!--<hr>-->
                                            <div class="col-xs-12 col-sm-6 col-lg-6 form-group display_control_section">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-lg-6 form-group display_control_section">
                                                <label class="col-xs-5  col-sm-5 col-lg-5  control-label" for="password-confirm">Confirm Password<span class="required">*</span></label>
                                                <div class="col-xs-7">
                                                    <div class="controls display_control_section">
    ...
    @section('footer')
        ...
        <script src="{{ URL::asset('pages/scripts/admin/user-detail.js')}}"></script>
