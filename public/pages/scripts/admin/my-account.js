	...
	*/
	...
	// Apply validation logic on my account edit form
	var MyAccountEditFormValidation = function () {

	    var handleValidation = function() {
	        // for more info visit the official plugin documentation:
	        // http://docs.jquery.com/Plugins/Validation

	        var form = $('#frm_my_account_edit');
	...
	jQuery(document).ready(function(){
		...
		MyAccountEditFormValidation.init();

		//Display form for edit information and hide readonly information
	    jQuery('#anc_edit_my_account').on('click',function(){
	    ...
	    jQuery('#btnCancel').on('click',function(){
	        ...
	        jQuery("#frm_my_account_edit").clearValidation();
	    });
